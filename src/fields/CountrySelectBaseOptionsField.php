...
class CountrySelectBaseOptionsField extends BaseOptionsField
{
    ...
    /**
     * Returns the field's options setting label.
     *
     * @return string The field's options setting label
     */
    protected function optionsSettingLabel(): string
    {
        return Craft::t('country-select', 'Countries');
    }
     ...
     *
     * @return array|string|null The default value.
     */
